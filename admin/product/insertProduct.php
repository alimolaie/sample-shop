                ...
                <ul class="iconMenu-bar custom-scrollbar">
                    <li><a class="bar-icons" href="javascript:void(0)">
                        ...
                        <ul class="iconbar-mainmenu custom-scrollbar">
                            ...
                            <li><a href="insertProduct.php">افزودن محصول جدید</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>افزودن محصول</h5>
                                <form class="form theme-form" method="post" action="submitProduct.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">نام محصول:</label>
                                                    <input class="form-control" name="name"  type="text" placeholder="نام محصول">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput4">قیمت:</label>
                                                    <input class="form-control" type="number" name="price" placeholder="قیمت">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput7">تعداد:</label>
                                                    <input class="form-control" type="number" name="number" placeholder="تعداد">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="exampleFormControlSelect9"> دسته بندی: </label>
                                                    <select class="form-control digits" id="exampleFormControlSelect9" name=category>
                                                        <option value="1">کراتین</option>
                                                        <option value="2">گینر</option>
                                                        <option value="3">میکسر</option>
                                                        <option value="4">وی</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea4">تصویر محصول:</label>
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" name="insertProduct" class="btn btn-pill btn-primary" value="ثبت">
                                        <input class="btn btn-pill btn-light" type="reset" value="کنسل">
                                    </div>
                                </form>
                            </div>
                        </div>
