                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>افزودن محصول</h5>
                                <form class="form theme-form" action="updateProduct.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">نام محصول:</label>
                                                    <input class="form-control" name="name"  type="text" placeholder="نام محصول" value="<?= $name ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="price" placeholder="قیمت" value="<?= $price ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="number" placeholder="تعداد" <?= $number ?>>
                                                </div>
                                            </div>
                                        </div>
