                                     ...
                                     if ($result = $mySql->query($sql)) {
                                         while ($row = $result->fetch_row()) {
                                             ...
                                             <tr>
                                                 ...
                                                 <td><img src="../images/<?php echo $row[4] ?>" alt="products" width="50" height="50"></td>
                                                 <th><?php echo $row[5] ?></th>
                                                 <th><?php  echo $row[6] ?></th>
                                                 <td><a class="text-primary delete-confirm-user" href="deleteProduct.php?idProduct=<?php echo $row[0] ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                     <a class="text-danger" href="editProduct.php?idProduct=<?php echo $row[0] ?>" style="margin-right: 20px"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                 </td>
                                             </tr>
                                             <?php
                                         }
